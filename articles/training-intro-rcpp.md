...
```
    ...
    ## function (x, y, z) 
    ## .Call(<pointer: 0x7f5dbd5d0530>, x, y, z)
...
```
    ...
    ##   mean(x) 422.648 432.5365 437.4609 436.5295 441.4025   514.529   100
    ##  meanC(x) 371.904 372.1940 488.7175 372.8710 381.5265 11675.708   100
