...
```
    ...
    ## function (x, y, z) 
    ## .Call(<pointer: 0x7f3bf32f1530>, x, y, z)
...
```
    ...
    ##   mean(x) 424.071 431.4455 437.3621 436.2240 442.125   504.722   100
    ##  meanC(x) 371.423 371.8135 484.2394 372.6405 383.185 11065.459   100
