...
```
    ...
    ## function (x, y, z) 
    ## .Call(<pointer: 0x7f1add1d0530>, x, y, z)
...
```
    ...
    ##   mean(x) 421.846 431.5645 436.9379 435.7780 440.251   515.11   100
    ##  meanC(x) 371.934 372.3940 485.1509 372.8505 381.837 11241.15   100
