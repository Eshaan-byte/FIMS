...
```
    ...
    ## ℹ Total run time was 5.50897 seconds
...
```
    ...
    ## ✔ Finished sdreport
    ## ℹ FIMS model version: 0.9.0
    ## ℹ Total run time was 5.39062 seconds
    ## ℹ Number of parameters: fixed_effects=48, random_effects=29, and total=77
...
```
    ...
    ## ✔ Finished sdreport
    ## ℹ FIMS model version: 0.9.0
    ## ℹ Total run time was 5.83601 seconds
    ## ℹ Number of parameters: fixed_effects=48, random_effects=29, and total=77
...
```
    ...
    ## ✔ Finished optimization
    ## ✔ Finished sdreport
    ## ℹ FIMS model version: 0.9.0 ℹ Total run time was 1.13756 minutes ℹ Number of
...
```
    ...
    ## ✔ Finished optimization
    ## ✔ Finished sdreport
    ## ℹ FIMS model version: 0.9.0 ℹ Total run time was 5.39206 seconds ℹ Number of
    ## parameters: fixed_effects=48, random_effects=29, and total=77 ℹ Maximum
