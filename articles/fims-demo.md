...
```
    ...
    ## ℹ Total run time was 6.02019 seconds
...
```
    ...
    ##                  timestamp   level
    ## 1 Fri Apr  3 14:59:13 2026 warning
    ##                                                                   message id
...
```
    ...
    ##                  timestamp   level
    ## 1 Fri Apr  3 14:59:13 2026 warning
    ## 2 Fri Apr  3 14:59:13 2026 warning
    ##                                                                   message id
    ## 1 The log_f_multiplier vector is not of size n_years. Filling with zeros.  0
...
```
    ...
    ## ✔ Finished sdreport
    ## ℹ FIMS model version: 0.9.2
    ## ℹ Total run time was 5.96885 seconds
    ## ℹ Number of parameters: fixed_effects=49, random_effects=29, and total=78
...
```
    ...
    ## ✔ Finished sdreport
    ## ℹ FIMS model version: 0.9.2
    ## ℹ Total run time was 6.10468 seconds
    ## ℹ Number of parameters: fixed_effects=49, random_effects=29, and total=78
...
```
    ...
    ## ✔ Finished optimization
    ## ✔ Finished sdreport
    ## ℹ FIMS model version: 0.9.2 ℹ Total run time was 1.15233 minutes ℹ Number of
...
```
    ...
    ## ✔ Finished optimization
    ## ✔ Finished sdreport
    ## ℹ FIMS model version: 0.9.2 ℹ Total run time was 5.66341 seconds ℹ Number of
    ## parameters: fixed_effects=49, random_effects=29, and total=78 ℹ Maximum
