...
```
    ...
    ## ℹ Total run time was 6.08668 seconds
...
```
    ...
    ##                  timestamp   level
    ## 1 Thu Apr  9 06:56:20 2026 warning
    ##                                                                   message id
...
```
    ...
    ##                  timestamp   level
    ## 1 Thu Apr  9 06:56:20 2026 warning
    ## 2 Thu Apr  9 06:56:20 2026 warning
    ##                                                                   message id
    ## 1 The log_f_multiplier vector is not of size n_years. Filling with zeros.  0
...
```
    ...
    ## ✔ Finished sdreport
    ## ℹ FIMS model version: 0.9.2
    ## ℹ Total run time was 6.03506 seconds
    ## ℹ Number of parameters: fixed_effects=49, random_effects=29, and total=78
...
```
    ...
    ## ✔ Finished sdreport
    ## ℹ FIMS model version: 0.9.2
    ## ℹ Total run time was 6.18168 seconds
    ## ℹ Number of parameters: fixed_effects=49, random_effects=29, and total=78
...
```
    ...
    ## ✔ Finished optimization
    ## ✔ Finished sdreport
    ## ℹ FIMS model version: 0.9.2 ℹ Total run time was 1.12593 minutes ℹ Number of
...
```
    ...
    ## ✔ Finished optimization
    ## ✔ Finished sdreport
    ## ℹ FIMS model version: 0.9.2 ℹ Total run time was 5.66184 seconds ℹ Number of
    ## parameters: fixed_effects=49, random_effects=29, and total=78 ℹ Maximum
