...
```
    ...
    ## ℹ Total run time was 5.72651 seconds
...
```
    ...
    ##                  timestamp   level
    ## 1 Sun May 10 04:09:02 2026 warning
    ##                                                                   message id
...
```
    ...
    ##                  timestamp   level
    ## 1 Sun May 10 04:09:02 2026 warning
    ## 2 Sun May 10 04:09:02 2026 warning
    ##                                                                   message id
    ## 1 The log_f_multiplier vector is not of size n_years. Filling with zeros.  0
...
```
    ...
    ## ✔ Finished sdreport
    ## ℹ FIMS model version: 0.9.3
    ## ℹ Total run time was 5.6597 seconds
    ## ℹ Number of parameters: fixed_effects=49, random_effects=29, and total=78
...
```
    ...
    ## ✔ Finished sdreport
    ## ℹ FIMS model version: 0.9.3
    ## ℹ Total run time was 5.84077 seconds
    ## ℹ Number of parameters: fixed_effects=49, random_effects=29, and total=78
...
```
    ...
    ## ✔ Finished optimization
    ## ✔ Finished sdreport
    ## ℹ FIMS model version: 0.9.3 ℹ Total run time was 1.10445 minutes ℹ Number of
...
```
    ...
    ## ✔ Finished optimization
    ## ✔ Finished sdreport
    ## ℹ FIMS model version: 0.9.3 ℹ Total run time was 5.4062 seconds ℹ Number of
    ## parameters: fixed_effects=49, random_effects=29, and total=78 ℹ Maximum
