...
```
    ...
    ## ℹ Total run time was 1.24393 minutes
...
```
    ...
    ## ✔ Finished sdreport
    ## ℹ FIMS model version: 0.8.1
    ## ℹ Total run time was 1.22758 minutes
    ## ℹ Number of parameters: fixed_effects=77, random_effects=0, and total=77
...
```
    ...
    ## ✔ Finished sdreport
    ## ℹ FIMS model version: 0.8.1
    ## ℹ Total run time was 1.2229 minutes
    ## ℹ Number of parameters: fixed_effects=77, random_effects=0, and total=77
...
```
    ...
    ## ✔ Finished optimization
    ## ✔ Finished sdreport
    ## ℹ FIMS model version: 0.8.1 ℹ Total run time was 9.79354 seconds ℹ Number of
...
```
    ...
    ## ✔ Finished optimization
    ## ✔ Finished sdreport
    ## ℹ FIMS model version: 0.8.1 ℹ Total run time was 59.58858 seconds ℹ Number of
    ## parameters: fixed_effects=77, random_effects=0, and total=77 ℹ Maximum
